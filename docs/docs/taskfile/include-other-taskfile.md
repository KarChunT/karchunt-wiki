...
- You can use `default` keyword to set the default task for the included Taskfile, then you can override the variable values in the `vars` keyword. Refer [here](../variables#set-default-values-for-variables)
