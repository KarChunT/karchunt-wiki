...
```python linenums="1" title="app.py" hl_lines="11"
import os
from flask import Flask
...
![horizontal-scaling](../assets/twelve-factor-app/horizontal-scaling.gif)
...
![admin-processes](../assets/twelve-factor-app/admin-processes.gif)
